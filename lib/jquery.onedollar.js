  ...
  $.fn.extend({
    onedollar: function(data) {
      return this.each(function() {
        var bind, isArray, length, mouse_click, one, template, touch_event, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
        one = null;
        ...
        if (isArray(data)) {
          ...
          if (length !== null) {
            one = new window.OneDollar(length === 3 ? parseInt(data[0]) : 80);
            _ref = data[length - 2];
          ...
          if (typeof data.templates !== 'undefined' && typeof data.binds !== 'undefined') {
            one = new window.OneDollar(typeof data.score !== 'undefined' ? parseInt(data.score) : 80);
