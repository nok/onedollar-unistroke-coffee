window.OneDollar = (function() {
      ...
      if (ranking[0].score >= this.CFG.score) {
        args = {
          ...
          path: {
            ...
            centroid: this.___getCentroid(this.__convert(raw))
          },
          ranking: ranking
        };
  ...
  OneDollar.prototype.__resample = function(points) {
    ...
    seperator = (this.___getLength(points)) / (this.ALGO.parts - 1);
    distance = 0;
    result = [];
  ...
  OneDollar.prototype.__rotateToZero = function(points) {
    var centroid, theta;
    centroid = this.___getCentroid(points);
  ...
  OneDollar.prototype.___getCentroid = function(points) {
  ...
  OneDollar.prototype.___getLength = function(points) {
