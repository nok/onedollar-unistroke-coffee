...
(function() {
  "use strict";  window.OneDollar = (function() {
    ...
    function OneDollar(parts, size, angle, step) {
      if (parts == null) {
        parts = 64;
      }
      if (size == null) {
    ...
    OneDollar.prototype.check = function(points) {
      var args, difference, name, space, template, template_points, _ref;
      ...
      if (template !== null) {
        args = {
          name: template,
          score: ((1.0 - difference / this.MATH.HALFDIAGONAL) * 100).toFixed(2)
        };
