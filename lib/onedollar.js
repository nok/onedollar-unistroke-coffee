...
(function() {
  "use strict";  window.OneDollar = (function() {
    ...
    OneDollar.prototype._transform = function(points) {
      ...
      points = this.__rotate(points);
      points = this.__scale(points);
      points = this.__translate(points);
      return points;
    };
    ...
    OneDollar.prototype.__rotate = function(points) {
      var centroid, cos, i, point, sin, theta, x, y, _i, _len;
    ...
    OneDollar.prototype.__scale = function(points) {
      var height, i, maxX, maxY, minX, minY, point, width, x, y, _i, _j, _len, _len1;
    ...
    OneDollar.prototype.__translate = function(points) {
      var centroid, point, _i, _len;
