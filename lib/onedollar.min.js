...
function(a,b){this.binds[a]=b;return this};f.prototype.off=function(a){void 0!==this.binds[a]&&delete this.binds[a];return this};f.prototype.check=function(a){var b,c,d,e,g,h;b=a;if(0<a.length)a=this._transform(a);else return!1;c=Infinity;g=null;h=this.temps;for(d in h)e=h[d],void 0!==this.binds[d]&&(e=this.__find_best_template(a,e),e<c&&(c=e,g=d));return null!==g&&(a=parseFloat((100*(1-c/this.MATH.HALFDIAGONAL)).toFixed(2)),a>=this.config.score)?(b={name:g,score:a,path:{start:new k(b[0][0],b[0][1]),
end:new k(b[b.length-1][0],b[b.length-1][1]),centroid:this.___get_centroid(this.__convert(b))}},this.binds[g].apply(this,[b]),b):!1};f.prototype._transform=function(a){a=this.__convert(a);a=this.__resample(a);a=this.__rotate_to_zero(a);a=this.__scale_to_square(a);return a=this.__translate_to_origin(a)};f.prototype.__convert=function(a){var b,c,d,e;c=[];d=0;for(e=a.length;d<e;d++)b=a[d],c.push(new k(b[0],b[1]));return c};f.prototype.__resample=function(a){var b,c,d,e,g,h;g=this.___get_length(a)/(this.ALGO.parts-
1);b=0;for(e=[];0!==a.length;)if(d=a.pop(),0===e.length)e.push(d);else{if(0===a.length){e.push(d);break}c=a[a.length-1];h=d.dist(c);if(b+h>=g){if(c=new k(d.x+(g-b)/h*(c.x-d.x),d.y+(g-b)/h*(c.y-d.y)),e.push(c),a.push(c),b=0,e.length===this.ALGO.parts-1){e.push(a[a.length-1]);break}}else b+=h}if(e.length!==this.ALGO.parts){c=e[e.length-1];a=g=e.length;for(b=this.ALGO.parts;g<=b?a<b:a>b;g<=b?++a:--a)e.push(c)}return e};f.prototype.__rotate_to_zero=function(a){var b,c;b=this.___get_centroid(a);c=Math.atan2(b.y-
