(function(){window.OneDollar=function(){function f(a,b,c,d,e){null==a&&(a=80);null==b&&(b=64);null==c&&(c=250);null==d&&(d=45);null==e&&(e=2);this.VERSION="1.0.0";this.config={score:a};this.MATH={PHI:0.5*(-1+Math.sqrt(5)),HALFDIAGONAL:0.5*Math.sqrt(c*c+c*c)};this.ALGO={parts:b,size:c,angle:d,step:e};this.temps={};this.binds={}}var l;l=function(){function a(a,c){this.x=null!=a?a:0;this.y=null!=c?c:0}a.prototype.dist=function(a){return Math.sqrt(Math.pow(this.x-a.x,2)+Math.pow(this.y-a.y,2))};a.prototype.add=
